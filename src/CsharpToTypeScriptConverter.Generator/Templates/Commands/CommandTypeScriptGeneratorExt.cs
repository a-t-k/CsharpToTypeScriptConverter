...
namespace TypeScriptRequestCommandsGenerator.Templates.Commands
{
    public partial class CommandTypeScriptGenerator
    {
        ...
        public IEnumerable<GeneratorType> Classes(GeneratorType[] generatorTypes) => generatorTypes.Where(t => t.Kind == GeneratorTypeKind.Class || t.Kind == GeneratorTypeKind.Interface);
